...
import (
	...
	secp_ecdsa "github.com/mleku/ec/secp"
	ecdsa_schnorr "github.com/mleku/ec/secp/schnorr"
)
...
var bip340TestVectors = []bip340Test{
	...
	// TODO: These should pass the test but the full BIP 340 algorithm has not
	//  been implemented for dealing with short messages. For most purposes
	//  signing an SHA256 hash is the norm.
	//
	// {
